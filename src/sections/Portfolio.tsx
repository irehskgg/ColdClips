...
export function Portfolio() {
  return (
    ...
    >
      <Reveal>
        <h2 className="text-center text-base md:text-3xl font-semibold tracking-tight mb-8">
          Gus Trades
        </h2>
      </Reveal>
      <div className="mx-auto max-w-3xl grid grid-cols-3 gap-2 md:gap-4">
        {gusReels.map((reel, i) => (
      ...
      <div className="mx-auto max-w-3xl mt-10 md:mt-14">
        <div className="grid grid-cols-3 gap-2 md:gap-4 mb-6">
          <Reveal className="col-span-2">
            <h2 className="text-center text-base md:text-3xl font-semibold tracking-tight">
              Tursonzz
            </h2>
          </Reveal>
          <Reveal>
